...
class ConfigManager:
    ...
    def _build_translation_config(self, project_dir: str) -> TranslationConfig:
        ...
        return TranslationConfig(
            ...
            traditional_block_max_wait=max(0.0, float_value(translation_section.get("traditional_block_max_wait", 60.0), 60.0)),
    ...
    def _build_quality_config(self) -> QualityConfig:
        ...
        return QualityConfig(
            ...
            visual_inpaint_verifier=bool_value(q.get("visual_inpaint_verifier", True), True),
            visual_inpaint_retry=bool_value(q.get("visual_inpaint_retry", True), True),
            visual_inpaint_retry_models=str(q.get("visual_inpaint_retry_models", "solid,opencv-tela,lama_mpe,aot")),
