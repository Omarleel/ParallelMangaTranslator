...
class JobOptions:
    ...
    # Fuente de regiones por trabajo: yolo | comic_text_detector | rtdetr. Se elige por
    # trabajo y no globalmente porque su ventaja depende del material, medido en dataset_eval.
